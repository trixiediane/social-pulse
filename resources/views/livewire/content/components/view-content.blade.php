        ...
        <div class="max-w-3xl px-4 pt-6 lg:pt-10 pb-12 sm:px-6 lg:px-8 mx-auto">
            <div class="max-w-2xl">
                ...
                <div class="space-y-5 md:space-y-8">
                    <div class="space-y-3">
                        <h2 class="text-2xl font-bold md:text-3xl">{{ $content->title }}</h2>
                        <p class="text-lg text-gray-800">{{ $content->short_description }}</p>
                    </div>
                    <figure>
                        <img class="w-full object-cover rounded-xl" src="{{ Storage::url($content->photo) }}"
                            alt="Blog Image">
                    </figure>

                    <p class="text-lg text-gray-800">{{ $content->body }}</p>
