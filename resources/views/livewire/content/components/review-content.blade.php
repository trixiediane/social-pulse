                ...
                <div class="overflow-hidden">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <thead>
                            <tr>
                                <th scope="col"
                                    class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">User</th>
                                <th scope="col"
                                    class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">Title</th>
                                <th scope="col"
                                    class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">Submitted
                                    at</th>
                                <th scope="col"
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            @foreach ($contents as $content)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800">{{ $content->title }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800">
                                        {{ $content->created_at }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                        <a class="group block rounded-xl overflow-hidden focus:outline-none"
                                            href="{{ route('content.view', $content->slug) }}">View</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
